...
rn1, vn1, itn1, errn1 = AT.mstycznych(f1,df1, 2.0,δ, ϵ, 40)
rn2, vn2, itn2, errn2 = AT.mstycznych(f2,df2, 0.9,δ, ϵ, 40)
rs1, vs1, its1, errs1 = AT.msiecznych(f1,-0.5,0.0,δ, ϵ, 40)
rs2, vs2, its2, errs2 = AT.msiecznych(f2,0.125, 0.5,δ, ϵ, 40)
